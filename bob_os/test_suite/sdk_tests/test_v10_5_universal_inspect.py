...
class TestV105UniversalInspect(unittest.TestCase):
    ...
    def test_inspect_ship_vessel(self):
        ...
        self.assertEqual(ship_data['blueprint_name'], "Custom-Scout")
        self.assertEqual(ship_data['mass'], 240)
        self.assertEqual(ship_data['energy_capacity'], 5000)
        self.assertEqual(ship_data['has_logic_core'], 1)
        self.assertEqual(ship_data['has_drill'], 0)

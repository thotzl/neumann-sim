...
base_state = {
    ...
    "systems": [
        {"name": "SYS-X0-Y0", "display_name": "Home", "x": 0, "y": 0, "resources": 5000, "energy_rate": 10, "infra": []}
    ],
    "agents": [
        {"id": "Bob-1", "chosen_name": "Original", "location": "SYS-X0-Y0", "matter": 50, "energy": 120, "storage_limit": 100, "status": "active", "last_manifestation": "Stable state."}
    ],
    "events": []
}
...
s1 = base_state.copy()
s1["tick"] = 43
s1["agents"][0]["matter"] = 80
s1["agents"][0]["energy"] = 110
...
s2 = base_state.copy()
s2["tick"] = 44
s2["systems"].append({"name": "SYS-X500Y500", "display_name": "New World", "x": 500, "y": 500, "resources": 3000, "energy_rate": 5, "infra": []})

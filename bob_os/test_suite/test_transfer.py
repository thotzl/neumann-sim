...
class TestTransfer(unittest.TestCase):
    def setUp(self):
        ...
        c.execute("INSERT INTO agents VALUES ('Instance-1', 'Instance-1', 'SYS-A', 100, 50, 0, 300, 'active', 0, 0, 1)")
        c.execute("INSERT INTO agents VALUES ('Instance-2', 'Instance-2', 'SYS-A', 50, 0, 0, 100, 'active', 0, 0, 1)")
        conn.commit()
        conn.close()

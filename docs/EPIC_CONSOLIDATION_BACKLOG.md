...
| **TCK-108** | SSoT Sektor-Weichen: "Ready for Deeper Verse" (Epic 5 Setup) | Epic 5 / Runway | `closed` | `low` | [Link](../.tickets/closed/TCK-108-deeper-verse-runway-setup.md) | [ROADMAP.md](../.tickets/resources/todo/ROADMAP.md), [ADV_MECH_DUMP](../.tickets/resources/todo/ADVANCED_MECHANICS_DUMP.md), [ROADMAP_WORLD](../.tickets/resources/todo/ROADMAP_WORLD_MECHANICS.md) |
...
| **TCK-134** | Swarm Safety, SDE-Kognition Model & Self-Documenting SDK Architecture | Epic 2 (V10.0) / Phase 2.6 | `open` | `high` | [Link](../.tickets/open/TCK-134-swarm-safety-and-rescue-mechanics.md) | [Central Test Hub](../../tests/test_all.js) |
...
| **TCK-136** | Unified Environmental & Perception Physics Integration | Epic 5 / Deeper Universe | `open` | `high` | [Link](../.tickets/open/TCK-136-unified-environmental-and-perception-physics.md) | [Central Test Hub](../../tests/test_all.js) |

...
def move(agent_id, target):
    if "--help" in sys.argv:
        print("Syntax: python3 tools/move.py <deine_id> <ziel_system>")
        print("Beschreibung: Reist in ein anderes System. Kostet Energie basierend auf der Entfernung.")
        return
...
if __name__ == "__main__":
    if "--help" in sys.argv:
        ...
        print("[VERWEIGERT] Syntax: python3 tools/move.py <agent_id> <ziel_system>. Nutze --help für Details.")

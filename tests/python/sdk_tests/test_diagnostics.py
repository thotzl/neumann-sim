...
class TestDiagnostics(unittest.TestCase):
    ...
    def test_list_memory_banks(self):
        ...
        c.execute("CREATE TABLE scripts (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, content TEXT, path TEXT NOT NULL, target TEXT DEFAULT NULL, owner_id TEXT NOT NULL, read_key TEXT DEFAULT NULL, write_key TEXT DEFAULT NULL, created_cycle INTEGER DEFAULT 0)")
        ...
        c.execute("INSERT INTO scripts (name, content, path, target, owner_id, read_key, write_key, created_cycle) VALUES ('my_script.py', 'print(''hello'')', 'scripts/active/my_script.py', NULL, 'Test-Bob', NULL, 'secret', 0)")
        conn.commit()
        conn.close()

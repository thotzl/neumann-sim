...
class TestEpic2Disembodied(unittest.TestCase):
    def setUp(self):
        ...
        conn.execute("INSERT INTO agents (id, chosen_name, host_id, host_type, status, active_ship_id, current_x, current_y) VALUES ('Instance-1', 'Pioneer', '100', 'matrix', 'active', NULL, 0, 0)")
        conn.execute("INSERT INTO agents (id, chosen_name, host_id, host_type, status, active_ship_id, current_x, current_y) VALUES ('Instance-2', 'Clone', '100', 'matrix', 'active', NULL, 0, 0)")
        conn.execute("INSERT INTO ships (id, name, chassis, pilot_id, system_name, raw_matter_inventory, energy_inventory, matter_storage_capacity, has_drill, has_fabricator, x, y) VALUES (2, 'Fighter', 'Scout', NULL, 'SYS_X0_Y0', 0, 100, 100, 1, 1, 0, 0)")

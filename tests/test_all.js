...
async function start() {
    ...
    const tests = [
        ...
        { name: "Python Ship Balancing Simulation", cmd: "PYTHONPATH=src/bob_os:src python3 src/sim_engine/verify_ship_balancing.py" },
        { name: "Python Economy Balancing Simulation", cmd: "PYTHONPATH=src/bob_os:src python3 src/sim_engine/verify_economy_balancing.py" },

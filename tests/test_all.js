...
async function start() {
    ...
    const tests = [
        { name: "Python Core Services", cmd: "PYTHONPATH=src/bob_os:src python3 tests/python/test_core_services.py" },
        ...
        { name: "Python Seeder Integration (Test/Prod)", cmd: "PYTHONPATH=src/bob_os:src python3 tests/python/test_seeder.py" },
        ...
        { name: "JS Round Order Execution Sequence Integration", cmd: "node tests/js/test_execution_order_sequence.js" },
        ...
        { name: "JS Mailbox Service Unit", cmd: "node tests/js/test_mailbox_service.js" },
        ...
        { name: "SQLite Unified Views Integration", cmd: "node tests/js/test_v12_1_views.js" },
